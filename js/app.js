...
cardapio.metodos = {
    ...
    // altera os textos e exibe os botões nas etapas
    carregarEtapa: (etapa) => {
    ...
    resumoPedido: () => {
        ...
        if (uf.length == -1) {
            cardapio.metodos.mensagem('Por favor, informe a UF.');
            $("#ddlUF").focus();
            return;
        }
    ...
    carregarBotaoReserva: () => {
        ...
        let texto = 'Olá! gostaria de gazer uma *reserva*';
